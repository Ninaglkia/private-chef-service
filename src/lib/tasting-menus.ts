...
export interface TastingMenu { name: string; tag: string; price: number; meal?: MealKind; serviceExtraEur?: number; serviceExtraLabel?: string; minGuests?: number; courses: TastingCourse[] }
